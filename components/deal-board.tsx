...
export default function DealBoard({
  ...
  return (
    <div>
      <div className="thin-scroll -mx-1 flex snap-x gap-3 overflow-x-auto px-1 pb-4">
        {STAGES.map((stage) => {
          ...
          return (
            <div
              ...
              onDrop={() => drop(stage)}
              className={cn(
                "flex w-64 shrink-0 snap-start flex-col rounded-2xl border border-t-4 bg-chalk/70 transition-colors sm:w-72",
                STAGE_TINT[stage],
